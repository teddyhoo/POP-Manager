(function (namespace, $) {
	...
	var LeashtimeCalendar = function () {
	...
	var p = LeashtimeCalendar.prototype;
	...
	p.handleCalendarPrevClick = function (e) {
		$('#calendar').fullCalendar('prev');
		this.displayDate();
	};
	p.handleCalendarNextClick = function (e) {
		$('#calendar').fullCalendar('next');
		this._displayDate();
	};
	p.handleCalendarMode = function (e) {
	...
	// =========================================================================
	namespace.materialadmin.LeashtimeCalendar = new LeashtimeCalendar;
